...
DATASET_PATH_X = "datasets/x_dataset.csv"
DATASET_PATH_Y = "datasets/y_dataset.csv"

# Get dataset
df_x = pd.read_csv(DATASET_PATH_X, sep=",")
df_y = pd.read_csv(DATASET_PATH_Y, sep=",")
...
X = df_x[df_x.columns[-1]] # Only the MFCC features
y = df_y[df_y.columns[-1]] # Emotion label
